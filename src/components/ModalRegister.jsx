                      ...
                      <div className="pt-[10px] pb-[10px] px-[80px] h-full">
                        ...
                        <div className="mt-3">
                          <div className="mb-3 pt-0 max-w-[42.4rem] w-full m-auto">
                            ...
                            <div className="grid grid-cols-6 gap-4">
                              ...
                              <div class="relative z-0 mb-5 w-full group col-span-2">
                                <input
                                  ...
                                  id="floating_email"
                                  autoComplete="off"
                                  class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500x` focus:outline-none focus:ring-0 focus:border-green-500 peer"
                                  placeholder=" "
                                />
                                <label
                                  for="floating_email"
                            ...
                            {/* ========================================================== */}
                            <div className="grid grid-cols-6 gap-4">
                              <div class="relative z-0 mb-5 w-full group col-span-5">
                                <input
                                  type="text"
                                  name="floating_sdt"
                                  id="floating_sdt"
                              ...
                              <div class="relative z-0 mb-5 w-full group col-span-1">
                                <button
                                  type="button"
                                  class="block  text-[8px] h-full w-full font-semibold text-center text-green-600 bg-white  border-b border-gray-300 focus:outline-none "
                                >
                                  .dacloud.vn
                                </button>
                              </div>
                            ...
                            {/* ========================================================== */}
                            <div className="grid grid-cols-6 gap-4">
                              <div class="relative z-0 mb-5 w-full group col-span-3">
                                <input
                                  type="text"
                                  name="floating_sdt"
                                  id="floating_sdt"
                            ...
                            <div className="grid grid-cols-6 gap-4">
                              <div class="relative z-0 mb-5 w-full group col-span-3">
                                <button
                                  type="button"
                                  class="block  text-[8px] h-full w-full font-semibold text-center text-green-600 bg-green-100 hover:bg-green-200 rounded-full  focus:outline-none "
                                >
                            ...
                            <div className="flex justify-end gap-5 pt-4">
                              ...
                              onClick={function (event) {
                                ...
                                type="button"
                                class="text-green-500 border border-solid border-current bg-white hover:bg-green-100 focus:outline-none  font-medium rounded-full text-sm px-6 py-2.5 text-center flex leading-[23px] gap-2"
                              >
                              ...
                              <button
                                type="button"
                                class="text-white bg-green-500 hover:bg-green-600 focus:outline-none  font-medium rounded-full text-sm px-6 py-2.5 text-center flex leading-[23px] gap-2"
                              >
                                Đăng ký tài khoản
