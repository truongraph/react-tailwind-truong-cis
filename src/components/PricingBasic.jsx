  ...
  return (
    <>
      ...
      <div className="p-12 w-full  bg-white rounded-xl shadow-md">
        <h5 className="mb-4 text-[17px] uppercase font-semibold text-amber-500 ">
          Gói cơ bản
        </h5>
        <p className="mt-2 mb-2 text-[14px]">Dành cho những mô hình kinh doanh
nhỏ, cho người bắt đầu kinh doanh</p>
        <div className="flex items-baseline ">
          <span className="text-[30px] font-bold tracking-tight text-amber-500">
            500.000
          </span>
          <span className="ml-1 text-[15px] font-medium text-amber-500">
            /tháng
          </span>
        </div>
        ...
        <button
          type="button"
          className="text-white bg-amber-500 hover:bg-amber-600 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-semibold rounded-full text-[15px] px-5 py-4 inline-flex justify-center w-full text-center"
        >
          Chọn gói này
        </button>
      </div>
